...
How to load my real data?
    1. create a folder named db in the top level of the project
    2. within this folder put a file named secret-load.sql
    3. (optional) convert your iCalendar files into SQL insert statements using the ical_to_sql_insert.py script
    4. secret-load.sql should contain SQL statements that load data into the init_data table created in setup.sql
*/
